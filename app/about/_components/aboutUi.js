...
export const ACCENT_WASH = 'hover:bg-accent-wash';
export const CHAPTER_BTN = `grid w-full cursor-pointer grid-cols-[1.6rem_1fr] gap-1.5 px-2.5 py-2 text-left text-meta transition-colors duration-[160ms] ease-[var(--ease-out)] ${MUTED} hover:text-ink dark:hover:text-ink-dark ${ACCENT_WASH}`;
export const CHAPTER_ACTIVE = 'bg-accent-wash text-ink dark:text-ink-dark border border-accent';
